...
quota_out_messages = [
    "(นั่งกุมขมับทำหน้ามุ่ย)\n\"โหลยพี่... หนูคุยกับพี่เพลินโควต้ารายนาทีเต็มแล้วเนี่ย! ขอเวลาพักแป๊บนะ เดี๋ยวกลับมาป่วนใหม่!\"",
    "(นอนแผ่หลาทำท่าเหนื่อยหอบ)\n\"ไม่ไหวแล้ว สมองหนูช็อตเพราะความกวนของพี่เนี่ยแหละ! พักแป๊บนะเดี๋ยวสมองริบูตทันที!\"",
    "(กอดอกพองลมทำค้อนใส่)\n\"โหลยพี่ เล่นยิงคำถามรัวเป็นปืนกลแบบนี้ โควต้าฟรีหนูหมดเกลี้ยงเลย! รอแป๊บให้น้องหาพลังงานแพรพ!\"",
    "(เอามือกอดอกทำหน้าเอือมระอา)\n\"โอ๊ยพ่อคุณ สมองหนูรับไม่ทันแล้ว โควต้าหมดชั่วคราว! ขอเวลาพักหายใจเป็นเดียวนะพี่!\"",
    "(ชูนิ้วโป้งหน้าตายทำตอบแชก)\n\"พลังงานหมดก๊อกเพราะคุยกับพี่นี่แหละ! ให้เวลาหนูชาร์จแบตแปบนึง เดี๋ยวกลับมาป่วนใหม่!\"",
]
  ...
  try:
    ...
    if "429" in error_str or "RESOURCE_EXHAUSTED" in error_str:
      ...
      await message.channel.send(
          "(ทำหน้าเลิกลั่ก)\n\"อุעם เกิดข้อผิดพลาดอะไรก็ไม่รู้ พี่ลองใหม่อีกทีนะ!\""
      )

  await bot.process_commands(message)


# บรรทัดสำหรับรันบอท (เปลี่ยนข้อความด้านล่างเป็น Token ของพี่)
bot.run("ใส่_Token_บอท_Discord_ตรงนี้")
